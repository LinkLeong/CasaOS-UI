...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CasaOsLocalStorageApi.GetMounts200ResponseAllOf();
  });
  ...
  describe('GetMounts200ResponseAllOf', function() {
    it('should create an instance of GetMounts200ResponseAllOf', function() {
      // uncomment below and update the code to test GetMounts200ResponseAllOf
      //var instance = new CasaOsLocalStorageApi.GetMounts200ResponseAllOf();
      //expect(instance).to.be.a(CasaOsLocalStorageApi.GetMounts200ResponseAllOf);
    });
